...
export default function LoginPage() {
    ...
    return (
        <main className="max-w-md mx-auto mt-20 p-8 border-4 border-[#800000] dark:border-[#a855f7] secret:border-[#1cf85d] bg-gradient-to-br from-[#fdfbf7] to-[#f4ebe1] dark:from-[#1e1e1e] dark:to-[#2b184a] secret:bg-none secret:bg-transparent shadow-[0_20px_50px_rgba(128,0,0,0.15)] dark:shadow-[0_0_40px_rgba(168,85,247,0.25)] secret:shadow-[0_0_20px_rgba(28,248,93,0.1)] relative z-20 transition-all duration-300 rounded-sm secret:rounded-none hover:shadow-[0_25px_60px_rgba(128,0,0,0.2)] dark:hover:shadow-[0_0_50px_rgba(168,85,247,0.4)] secret:hover:shadow-[0_0_30px_rgba(28,248,93,0.2)]">
            ...
            <h1 className="text-3xl font-bold text-[#800000] dark:text-[#c084fc] secret:text-[#1cf85d] text-center mb-8 border-b-2 border-[#800000] dark:border-[#a855f7] secret:border-[#1cf85d] pb-4 transition-colors secret:font-mono uppercase">
                Bejelentkezés
            </h1>
